...
\033[1;34m║[•] Author    : RADIF CHOWDHURY             

\033[1;34m║[•] Facebook  : Ethan Edward Kelvin            

\033[1;34m║[•] Whatsapp  : +8801917374748          

\033[1;34m║[•] Github    : github.com/MR-TOXIIC      

\033[1;34m║[•] Status    : FREE                         

\033[1;34m║[•] Network   : 3G, 4G/5G, WIFI         

\033[1;34m║[•] Version   : 2.0                        

\033[1;34m║[•] Tools     : TOXIC BOOMBER 
...
def sms_bombing():
    ...
    number= raw_input("\033[1;33m[+]\033[1;32m ENTER NUMBER \033[1;35m(Without +880) \033[1;32m: \033[1;36m")
    ...
    for sms in range(limit):
        ...
        if sms_limit == limit:
           ...
           os.system('xdg-open https://www.facebook.com/E1H4N.EDW4RD')
...
def intro():
    ...
    print ("\033[1;31m[1] \033[1;36mSTART BOMBING \033[1;31m(Only For Bangladesh) ")
    ...
    user_choise = raw_input("\033[1;34mRADIF\033[1;31m>>  ")
    ...
    if user_choise == "1":    	
       ...
       os.system('xdg-open https://www.facebook.com/E1H4N.EDW4RD')
         ...
         os.system('https://www.facebook.com/E1H4N.EDW4RD')

         os.system('xdg-open https://www.facebook.com/TOXIC.RADIF')
